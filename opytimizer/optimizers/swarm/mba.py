"""Modified Bat Algorithm based on the paper 'An Intelligent Secured Framework for Cyberattack Detection in Electric Vehicles’ CAN Bus Using Machine Learning'.
"""
